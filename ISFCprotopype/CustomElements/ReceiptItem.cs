...
namespace ISFCprotopype.CustomElements
{
    class ReceiptItem : Panel
    {
        ...
        private void InitializeComponent()
        {
            ...
            _itemNameLabel.Font = new Font(new FontFamily("Microsoft Sans Serif"), 12f);
            ...
            _itemNumericUpDown = new NumericUpDown();
            _itemNumericUpDown.Parent = _itemNumericUpDownWrap;
            _itemNumericUpDown.Width = _itemNumericUpDownWrap.Width - 8;
            _itemNumericUpDown.Maximum = 100;
            _itemNumericUpDown.Minimum = 0;
            _itemNumericUpDown.Value = 1;
            _itemNumericUpDown.Location = new Point(0, _itemNumericUpDownWrap.Height / 2);
            ...
            _itemWeightLabel.Font = new Font(new FontFamily("Microsoft Sans Serif"), 7.8f);
            ...
            _itemCostLabel.Font = new Font(new FontFamily("Microsoft Sans Serif"), 7.8f);
            ...
            _itemAmountLabel.Font = new Font(new FontFamily("Microsoft Sans Serif"), 7.8f);
            _itemAmountLabel.TextAlign = ContentAlignment.MiddleLeft;
            ...
            _itemAmountCostLabel = new Label();
            _itemAmountCostLabel.Text = string.Format("{0} {1}", (float)_itemNumericUpDown.Value * _itemCost, "₽");
            _itemAmountCostLabel.Font = new Font(new FontFamily("Microsoft Sans Serif"), 7.8f);
            _itemAmountCostLabel.TextAlign = ContentAlignment.MiddleRight;
